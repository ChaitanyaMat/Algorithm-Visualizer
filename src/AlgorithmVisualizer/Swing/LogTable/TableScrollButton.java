...
public class TableScrollButton extends JLayeredPane {
    ...
    private class ScrollLayerUI extends LayerUI<JScrollPane> {
        ...
        private final Image image = new ImageIcon(getClass().getResource("/Images/icon_up_w.png")).getImage();
        ...
        public void paint(Graphics g, JComponent c) {
            ...
            int y_over = 40 + gapy;
            int x = c.getWidth() - 40 - gapx;
            int y = (int) ((c.getHeight() - 50 - gapy) + (y_over * (1f - animate)));
            shape = new Ellipse2D.Double(x, y, 32, 32);
