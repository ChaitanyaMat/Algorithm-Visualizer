...
import AlgorithmVisualizer.Event.EventSwitchSelected;
...
public class Form_Sorting extends javax.swing.JPanel {
    ...
    public Form_Sorting(int index) {
        ...
        sortingPanel.setSpeed(speedSlider.getValue());
    ...
    private void init(int index) {
        ...
        order.addEventSelected(new EventSwitchSelected() {
            ...
            public void onSelected(boolean selected) {
                orderValue.setText(selected?"Descending":"Ascending");
                sortingPanel.setOrder(!selected);
            }
        });
        ...
        reset.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                start.setEnabled(true);
                sortingPanel.setLength(slider.getValue());
                sortingPanel.setOrder(sortingPanel.isOrder());
    ...
    private void initComponents() {
        ...
        order = new AlgorithmVisualizer.Swing.SwitchCustom();
        ...
        sortingPanel = new AlgorithmVisualizer.Panels.SortingPanel();
        ...
        controlPanelLayout.setHorizontalGroup(
            ...
            .addGroup(controlPanelLayout.createSequentialGroup()
                ...
                .addGroup(controlPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(orderValue, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(controlPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(controlPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(controlPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(orderValue, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(order, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10))
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tableScrollButton, javax.swing.GroupLayout.PREFERRED_SIZE, 559, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private AlgorithmVisualizer.Swing.SwitchCustom order;
    ...
    private AlgorithmVisualizer.Panels.SortingPanel sortingPanel;
